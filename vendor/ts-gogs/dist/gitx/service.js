...
export function composeHookEnv(doer, repo, ownerOverride) {
...
export function createDelegateHooks(repoPath) {
...
export async function initRepository(repo, opts = {}) {
...
function renderReadmeTemplate(name, repo) {
...
export function listVendorTemplates(kind) {
...
/** git clone --bare fork. */
export async function forkRepository(base, fork) {
...
async function commitsList(repoDir, rev, maxCount) {
...
export async function initWiki(repoDir) {
...
export function wikiBranch(repoDir) {
...
export function toWikiPageName(name) {
    let n = name;
    try {
